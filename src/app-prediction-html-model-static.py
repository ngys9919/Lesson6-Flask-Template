...
# It only provides static data handling and hence the user inputs are reset to default upon refresh (like after clicked "Predict" button).

# Sanity Check for Model Prediction (using model) via HTML
# Required1: Flask installed
# Required2: src/app-prediction-html-model-static.py in src directory
...
# $ python src/app-prediction-html-model-static.py
